...
class Flutterwave implements PaymentGateway
{
    ...
    public function pay($postDetails)
    {
        ...
        $options = [
            ...
            CURLOPT_HTTPHEADER => [
                "Content-Type: application/json",
                "Authorization: Bearer " . env('flutter_secret_key_test'),
            ],
        ];
    ...
    public function webhook(Request $request)
    {
        ...
        Log::info('Payment Reference Id: ' . $response_status['data']['tx_ref']);
        ...
        $amount = $response_status['data']['amount'] ?? null;
         $reference = $response_status['data']['tx_ref'];
         $meta = $response_status['data']['meta']?? null;
         $date = $response_status['data']['created_at']?? null;
